...
var _user$project$Track$unlike = function (track) {
	return _elm_lang$core$Native_Utils.update(
		track,
		{liked: false});
};
var _user$project$Track$like = function (track) {
	return _elm_lang$core$Native_Utils.update(
		track,
		{liked: true});
};
var _user$project$Track$recordProgress = F3(
	function (progress, currentTime, track) {
		return _elm_lang$core$Native_Utils.update(
			track,
			{progress: progress, currentTime: currentTime});
	});
var _user$project$Track$markAsErrored = function (track) {
	return _elm_lang$core$Native_Utils.update(
		track,
		{error: true});
};
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {id: a, artist: b, artwork_url: c, title: d, streamingInfo: e, sourceUrl: f, createdAt: g, liked: h, progress: i, currentTime: j, error: k};
										};
									};
								};
							};
...
var _user$project$Track$Youtube = function (a) {
	return {ctor: 'Youtube', _0: a};
};
var _user$project$Track$Soundcloud = function (a) {
...
var _user$project$Html_Extra$link = F4(
	function (followLink, target, attributes, children) {
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$href(target),
					_1: {
						ctor: '::',
						_0: A3(
							_elm_lang$html$Html_Events$onWithOptions,
...
var _user$project$Icons$heart = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-id', 'geomicon-heart'),
		_1: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$fill('currentColor'),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '16'),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 32 32'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '16'),
						_1: {
							ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$d('M0 10 C0 6, 3 2, 8 2 C12 2, 15 5, 16 6 C17 5, 20 2, 24 2 C30 2, 32 6, 32 10 C32 18, 18 29, 16 30 C14 29, 0 18, 0 10'),
				_1: {ctor: '[]'}
			},
			{ctor: '[]'}),
		_1: {ctor: '[]'}
	});
var _user$project$Icons$next = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '14px'),
		_1: {
			ctor: '::',
			_0: A2(_elm_lang$html$Html_Attributes$attribute, 'version', '1.1'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 12 14'),
				_1: {
					ctor: '::',
	...
	},
	{
		...
		_0: A3(
			...
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg$text('Skip'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$svg$Svg$g,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$id('Page-1'),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'stroke', 'none'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'stroke-width', '1'),
									_1: {ctor: '[]'}
								}
							}
						}
					...
					_0: A2(
						_elm_lang$svg$Svg$g,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'transform', 'translate(-2620.000000, -397.000000)'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$d('M2630,403 L2620,397 L2620,411 L2630,405 L2630,411 L2632,411 L2632,397 L2630,397 L2630,403 Z'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$id('Skip'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _user$project$Icons$error = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$id('svg3017'),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 17 20'),
				_1: {
					ctor: '::',
	...
	},
	{
		...
		_0: A3(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'bordercolor', '#666666'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'borderopacity', '1'),
					_1: {ctor: '[]'}
				}
			},
			{ctor: '[]'}),
		_1: {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$id('title3019'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$d('M 1.5198618,2.970639 15.440414,16.580311'),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$id('path3032'),
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'inkscape:connector-curvature', '0'),
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'sodipodi:nodetypes', 'cc'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'style', 'fill:none;stroke:#000000;stroke-width:3.5;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none'),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$d('M 15.405872,3.0051813 1.4853195,16.580311'),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$id('path3034'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'inkscape:connector-curvature', '0'),
										_1: {
...
var _user$project$Icons$playlist = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '18'),
		_1: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 12 12'),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '18'),
				_1: {ctor: '[]'}
			}
		}
	},
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$d('M7.5,4.5 L0,8.5 L0,0.5 L7.5,4.5 L7.5,4.5 Z M3,11 L3,10 L12,10 L12,11 L3,11 L3,11 Z M12,7 L12,8 L5,8 L5,7 L12,7 L12,7 Z M8.00000487,3.99835018 L12,3.99835018 L12,4.99835018 L8,4.99835018 L8,3.99835018 L8.00000487,3.99835018 L8.00000487,3.99835018 Z'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
...
var _user$project$Icons$pause = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '20px'),
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 14 20'),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '14px'),
					_1: {
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'xmlns', 'http://www.w3.org/2000/svg'),
						_1: {ctor: '[]'}
					...
					_0: A2(
						_elm_lang$svg$Svg$g,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'transform', 'translate(-2710.000000, -394.000000)'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$id('Pause'),
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'transform', 'translate(2710.000000, 394.000000)'),
										_1: {ctor: '[]'}
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$id('Rectangle-131-+-Rectangle-131'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A3(
												...
												'rect',
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$id('Rectangle-131'),
														_1: {
															ctor: '::',
															_0: A2(_elm_lang$html$Html_Attributes$attribute, 'width', '5'),
															_1: {
																ctor: '::',
																_0: A2(_elm_lang$html$Html_Attributes$attribute, 'x', '0'),
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'y', '0'),
																	_1: {ctor: '[]'}
																}
															}
														}
													...
													'rect',
													{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: A2(_elm_lang$html$Html_Attributes$attribute, 'x', '9'),
																	_1: {
																		ctor: '::',
																		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'y', '0'),
																		_1: {ctor: '[]'}
...
var _user$project$Icons$play = A2(
	_elm_lang$svg$Svg$svg,
	{
		ctor: '::',
		_0: A2(_elm_lang$html$Html_Attributes$attribute, 'height', '20px'),
					...
					_0: A2(
						_elm_lang$svg$Svg$g,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'transform', 'translate(-2758.000000, -394.000000)'),
									_1: {ctor: '[]'}
								}
							}
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$d('M2758,394 L2758,414 L2775,404 L2758,394 Z'),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$id('Play'),
										_1: {ctor: '[]'}
									}
								},
								{ctor: '[]'}),
...
var _user$project$Model$NavigationItem = F4(
	function (a, b, c, d) {
		return {displayName: a, href: b, page: c, playlist: d};
	});
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {tracks: a, radio: b, showRadioPlaylist: c, latestTracks: d, played: e, playing: f, currentPage: g, lastKeyPressed: h, currentTime: i, player: j, navigation: k};
										};
									};
								};
							};
...
var _user$project$Radio_Model$Playlist = F3(
	function (a, b, c) {
		return {id: a, status: b, nextLink: c};
	});
var _user$project$Radio_Model$Fetched = {ctor: 'Fetched'};
var _user$project$Radio_Model$Fetching = {ctor: 'Fetching'};
var _user$project$Radio_Model$NotRequested = {ctor: 'NotRequested'};
var _user$project$Radio_Model$emptyPlaylist = F2(
	function (id, fetchUrl) {
		return {
			id: id,
			status: _user$project$Radio_Model$NotRequested,
			nextLink: _elm_lang$core$Maybe$Just(fetchUrl)
		};
	});
var _user$project$Radio_Model$PageNotFound = {ctor: 'PageNotFound'};
var _user$project$Radio_Model$LatestTracksPage = {ctor: 'LatestTracksPage'};
var _user$project$Radio_Model$PlayedPage = {ctor: 'PlayedPage'};
var _user$project$Radio_Model$UpNextPage = {ctor: 'UpNextPage'};
var _user$project$Radio_Model$RadioPage = {ctor: 'RadioPage'};
var _user$project$Radio_Model$LatestTracks = {ctor: 'LatestTracks'};
var _user$project$Radio_Model$Radio = {ctor: 'Radio'};

var _user$project$Radio_Router$routes = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: '/', _1: _user$project$Radio_Model$RadioPage},
	_1: {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: '/queue/played', _1: _user$project$Radio_Model$PlayedPage},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '/queue/next', _1: _user$project$Radio_Model$UpNextPage},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '/latest', _1: _user$project$Radio_Model$LatestTracksPage},
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Radio_Router$pageToUrl = function (page) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'/404',
		A2(
			...
			_elm_lang$core$List$head(
				A2(
					...
					_user$project$Radio_Router$routes))));
};
var _user$project$Radio_Router$urlToPage = function (url) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Radio_Model$PageNotFound,
		A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Tuple$second,
			_elm_lang$core$List$head(
...
var _user$project$Radio_Ports$storeAuthToken = _elm_lang$core$Native_Platform.outgoingPort(
	'storeAuthToken',
	function (v) {
		return v;
	});

var _user$project$Update$addCmd = F2(
	function (newCmd, _p0) {
		var _p1 = _p0;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Update$identity = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _user$project$Update$andThen = F2(
	function (update, _p2) {
		var _p3 = _p2;
		var _p4 = update(_p3._0);
...
var _user$project$Update$when = F3(
	function (predicate, update, _p5) {
		var _p6 = _p5;
		var _p8 = _p6._0;
		var _p7 = _p6._1;
		return predicate(_p8) ? A2(
			_user$project$Update$andThen,
			update,
			{ctor: '_Tuple2', _0: _p8, _1: _p7}) : {ctor: '_Tuple2', _0: _p8, _1: _p7};
	});
...
if (typeof _user$project$Radio_Main$main !== 'undefined') {
    _user$project$Radio_Main$main(Elm['Radio']['Main'], 'Radio.Main', undefined);
}
